-- Example "uspGetDirectManager Tests Testing uspGetDirectManager with @businessentityid = 2"
-- ./spec/uspGetDirectManager.rb:4
...
-- ./spec/uspGetDirectManager.rb:7:in `block (2 levels) in <top (required)>'
-- *******************************************