...
-- 
--   expected TinyTds::Error with "Invalid Password Change", got #<TinyTds::Error: Could not find stored procedure 'Website.ActivateWebsiteLogon'.> with backtrace:
--     # ./spec/website/changePassword.rb:23:in `block (3 levels) in <top (required)>'
--     # ./spec/website/changePassword.rb:22:in `block (2 levels) in <top (required)>'
-- ./spec/website/changePassword.rb:22:in `block (2 levels) in <top (required)>'
-- *******************************************